    ...
    <div class="bg-gray-100 flex items-center justify-center min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            ...
            <form action="{{ route('users.store') }}" method="post">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700" for="email">Senha</label>
                    <input type="text" name="password" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500" placeholder="Senha" >
                </div>
                <button type="submit" class="w-full bg-blue-600 text-white font-bold py-2 rounded hover:bg-blue-700">Cadastar</button>
            </form>
        </div>
    </div>
